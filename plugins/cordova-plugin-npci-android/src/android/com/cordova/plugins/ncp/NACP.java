...
//      }
      ...
      final String verifiedMerchantVal = args.getJSONObject(0).getString("verifiedMerchantVal");
      final String forgotUpiPINEnabledVal = args.getJSONObject(0).getString("forgotUpiPINEnabledVal");
      final String issuerOTPLimitVal = args.getJSONObject(0).getString("issuerOTPLimitVal");
      final String aadharOTPLimitVal = args.getJSONObject(0).getString("aadharOTPLimitVal");
      final String captureCardDetailsVal = args.getJSONObject(0).getString("captureCardDetailsVal");

	  NHCPObject.setBankNameCredXML( bank,  type,  credType,  credSubType,  credDType,  credDLength,  atmCredType,  atmCredSubType,  atmCredDType,  atmCredDLength,  xmlPayload,  considerOtp, verifiedMerchantVal, forgotUpiPINEnabledVal, issuerOTPLimitVal, aadharOTPLimitVal, captureCardDetailsVal, callbackContext); 
    //verifiedMerchantVal, forgotUpiPINEnabledVal, issuerOTPLimitVal, aadharOTPLimitVal, captureCardDetailsVal,
      ...
      return true;
    } else if (action.equals("initiateAadhaarSetUpiPin")) {
      final String paymentAdd = args.getJSONObject(0).getString("paymentAddress");
      final String txnId = args.getJSONObject(0).getString("txnId");
      final String accountNo = args.getJSONObject(0).getString("accountNo");

      NHCPObject.initiateAadhaarSetUpiPin(paymentAdd, txnId, accountNo, callbackContext);
      return true;
      ...
      return true;
    // } else if (action.equals("initiateAadhaarChangeUpiPin")) {
    //   final String txnId = args.getJSONObject(0).getString("txnId");
    //   final String paymentAddress = args.getJSONObject(0).getString("paymentAddress");
    //   final String accountNo = args.getJSONObject(0).getString("accountNo");

    //   NHCPObject.initiateAadhaarChangeUpiPin(txnId, paymentAddress, accountNo, callbackContext);
    //   return true;
      ...
      return true;
    } else if (action.equals("setAadharOtpCredValues")) {
      final String credType = args.getJSONObject(0).getString("credType");
      final String credSubType = args.getJSONObject(0).getString("credSubType");
      final String credDType = args.getJSONObject(0).getString("credDType");
      final String credDLength = args.getJSONObject(0).getString("credDLength");

	  NHCPObject.setAadharOtpCredValues(credType, credSubType, credDType, credDLength, callbackContext);
      return true;
    } else if (action.equals("initiateMandate")) {
      final String txnId = args.getJSONObject(0).getString("txnId");
      final String payerAddress = args.getJSONObject(0).getString("payerAddress");
      final String payeeAddress = args.getJSONObject(0).getString("payeeAddress");
      final String amount = args.getJSONObject(0).getString("amount");
	  ...
	  NHCPObject.initiateMandate(txnId, payerAddress, payeeAddress, amount, payeeName, callbackContext);
      return true;
    } else if (action.equals("enableSmartIntent")) {
      final Boolean enable = args.getJSONObject(0).getBoolean("enable");
      final String activityName = args.getJSONObject(0).getString("activityName");

	  NHCPObject.enableSmartIntent(enable, activityName);
      return true;
    }
