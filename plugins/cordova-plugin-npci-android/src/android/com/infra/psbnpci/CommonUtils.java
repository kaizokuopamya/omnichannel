...
public class CommonUtils {
    public static String getChallenge(String type, String deviceId) {
        ...
        Utilities.showLogE("NPCI_MOBILE", "Challange From CL : " + request_challenge);
        return request_challenge;
    }

    public static String populateHMAC(String alg, String padding, String app_id, String mobile, String token,
                                      String deviceId, String random) {
        String hmac = null;
        try {
            CryptLib cryptLib = new CryptLib();
            String message = app_id + "|" + mobile + "|" + deviceId;
            byte[] hmacBytes = cryptLib.encrypt(alg,padding,
                    cryptLib.SHA256(message, random),
                    cryptLib.hexStringToByteArray(token), random);
            hmac = Base64.encodeToString(hmacBytes, Base64.DEFAULT);
        } catch (Exception e) {
            // Log.e(TAG, "populateHMAC ", e);
            Utilities.showLogE("NPCI_MOBILE", "populateHMAC Exception Error : " + e);
        }
        return hmac;
    }
    ...
    /*public static String populateHMAC(String alg, String padding, String app_id, String mobile, String token, String deviceId) {
        ...
        try {
            ...
            byte[] hmacBytes = cryptLib.encrypt(alg, padding, cryptLib.SHA256(message), tokenBytes);
    ...
    public static String getCredAllowed(String type, String credType, String credSubType, String credDType, String credDLength, String atmCredType, String atmCredSubType, String atmCredDType, String atmCredDLength, String otpType, String otpSubType, String otpDType, String otpDLenght) {
        ...
        if (type.equals("OTPMPINATM")) {
            ...
            credAllowedString = "{\n" + "\"CredAllowed\": [\n" + "{\n" + "\"type\": \"OTP\",\n" + "\"subtype\": \"SMS\",\n" + "\"dType\": \"NUM\",\n" + "\"dLength\": \"6\"\n" + "},\n" + "{\n" + "\"type\": " + credType + "," + "\"subtype\": " + credSubType + "," + "\"dType\": " + credDType + "," + "\"dLength\": " + credDLength + "},\n" + "{\n" + "\"type\": \"OTP\",\n" + "\"subtype\": \"AADHAAR\",\n" + "\"dType\": \"NUM\",\n" + "\"dLength\": \"6\"\n" + "}\n" + "]\n" + "}";
            //credAllowedString = "{\"CredAllowed\": [{\"type\": \"OTP\",\"subtype\": \"AADHAAR\",\"dType\": \"NUM\",\"dLength\": 6}]}";
        } else {
