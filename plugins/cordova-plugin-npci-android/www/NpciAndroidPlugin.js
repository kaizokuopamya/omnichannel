...
module.exports = {
    ...
    initiateAadhaarSetUpiPin: function(paramObj, successCallback, errorCallback) {
        exec(successCallback, errorCallback, 'NpciAndroidPlugin', 'initiateAadhaarSetUpiPin', [paramObj]);
    },
	...
	setAadharOtpCredValues: function(paramObj, successCallback, errorCallback) {
        exec(successCallback, errorCallback, 'NpciAndroidPlugin', 'setAadharOtpCredValues', [paramObj]);
    },
	initiateMandate: function(paramObj, successCallback, errorCallback) {
        exec(successCallback, errorCallback, 'NpciAndroidPlugin', 'initiateMandate', [paramObj]);
    },
	enableSmartIntent: function(paramObj, successCallback, errorCallback) {
        exec(successCallback, errorCallback, 'NpciAndroidPlugin', 'enableSmartIntent', [paramObj]);
    },
